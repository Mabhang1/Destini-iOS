...
struct StoryBrain{
    ...
    //get story title by storynumber
    func getStoryTitle()->String{
        return story[storyNumber].title
    }
    
    //get choice 1 by storynumber
    func getChoice1()->String{
        return story[storyNumber].choice1
    }
    
    //get choice 2 by storynumber
    func getChoice2()->String{
        return story[storyNumber].choice2
    }
    
    //Going to the next story as per choice destination defind where we create a new object referring to storynumber
